...
**Hypothesis**: A hybrid recommendation engine (product catalog + relationship data + semantic filtering, etc.) produces better gift ideas than traditional search or browsing.
