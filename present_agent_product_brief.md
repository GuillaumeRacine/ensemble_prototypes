...
1. Start chat via Instagram or Facebook Page → DMs Present Agent
...
5. Provide feedback, refine or accept, etc. until a gift is found or the user abandons the search.
6. Select the gift and follow steps for payment and delivery.
6. user Returns for next occasion with context retained 

**Core interactions:**
- Natural language chat (no forms/menus) - make it easy for user to type the least amount, and use buttons, text, etc. for easy mobile flows
